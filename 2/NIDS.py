...
class Bro:
    ...
    def run(self, netflow_data):
        """Run the Bro algorithm on netflow_data, returning a 
        ...
        if self.T == 0:
            print("Blocking "+str(len(blocked_hosts))+" hosts at T = 0")
        elif self.T == 100:
            print("Blocking "+str(len(blocked_hosts))+" hosts at T = 100")
